...
=========================================================================*/
/**
 * @class   myConnectivityFilter
 * @brief   extract data based on geometric connectivity
 *
 * myConnectivityFilter is a filter that extracts cells that share common
 ...
 * region).
 *
 * myConnectivityFilter is generalized to handle any type of input dataset.
 ...
 *
 * The behavior of myConnectivityFilter can be modified by turning on the
...
class myConnectivityFilter : public vtkPointSetAlgorithm
{
public:
  vtkTypeMacro(myConnectivityFilter, vtkPointSetAlgorithm);
  void PrintSelf(ostream& os, vtkIndent indent) override;

  /**
   * Construct with default extraction mode to extract largest regions.
   */
  static myConnectivityFilter* New();
...
private:
  myConnectivityFilter(const myConnectivityFilter&) = delete;
  void operator=(const myConnectivityFilter&) = delete;
};

/**
 * Return the method of extraction as a string.
 */
inline const char* myConnectivityFilter::GetExtractionModeAsString()
{
