/*=========================================================================
  ...
  Module:    myPolyDataConnectivityFilter.h
...
=========================================================================*/
/**
 * @class   myPolyDataConnectivityFilter
 * @brief   extract polygonal data based on geometric connectivity
 *
 * myPolyDataConnectivityFilter is a filter that extracts cells that
 ...
 * polygonal data.
 *
 * The behavior of myPolyDataConnectivityFilter can be modified by turning
...
#ifndef myPolyDataConnectivityFilter_h
#define myPolyDataConnectivityFilter_h
...
class myPolyDataConnectivityFilter : public vtkPolyDataAlgorithm
{
public:
  vtkTypeMacro(myPolyDataConnectivityFilter, vtkPolyDataAlgorithm);
   ...
   */
  static myPolyDataConnectivityFilter* New();
...
protected:
  myPolyDataConnectivityFilter();
  ~myPolyDataConnectivityFilter() override;
  ...
  int minCellsInRegion;

private:
  myPolyDataConnectivityFilter(const myPolyDataConnectivityFilter&) = delete;
  void operator=(const myPolyDataConnectivityFilter&) = delete;
};

/**
 * Return the method of extraction as a string.
 */
inline const char* myPolyDataConnectivityFilter::GetExtractionModeAsString()
{
